...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ WATSAPPP🤲https:wa.me/±919582492941")
	subprocess.check_output(["am", "start", "https://wa.me/±919582492941"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Rahulthakur12/file.txt/blob/main/Filee.txt').text
			if basesplit in plr:
				key = basesplit
...
___  ___          _____ _           _               
|  \/  |         |_   _| |         | |              
| .  . |_ __ ______| | | |__   __ _| | ___   _ _ __ 
| |\/| | '__|______| | | '_ \ / _` | |/ / | | | '__|
| |  | | |         | | | | | | (_| |   <| |_| | |   
